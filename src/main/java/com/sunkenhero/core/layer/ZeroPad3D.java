...
public class ZeroPad3D implements Layer {

    private static final long serialVersionUID = -6934321137808095219L;
    ...
    public ZeroPad3D(int inputWidth, int inputHeight, int inputChannel, int padding) {
        this(inputWidth, inputHeight, inputChannel, padding, padding);
    }

    public ZeroPad3D(int inputWidth, int inputHeight, int inputChannel, int paddingX, int paddingY) {
        this(inputWidth, inputHeight, inputChannel, paddingX, paddingX, paddingY, paddingY);
    }

    public ZeroPad3D(int inputWidth, int inputHeight, int inputChannel, int paddingLeft, int paddingRight,
