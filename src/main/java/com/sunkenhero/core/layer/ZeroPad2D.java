...
public class ZeroPad2D implements Layer {

    private static final long serialVersionUID = -275227157591807139L;
    ...
    public ZeroPad2D(int inputWidth, int inputHeight, int padding) {
        this(inputWidth, inputHeight, padding, padding);
    }

    public ZeroPad2D(int inputWidth, int inputHeight, int paddingX, int paddingY) {
        this(inputWidth, inputHeight, paddingX, paddingX, paddingY, paddingY);
    }

    public ZeroPad2D(int inputWidth, int inputHeight, int paddingLeft, int paddingRight, int paddingTop,
            int paddingBottom) {
